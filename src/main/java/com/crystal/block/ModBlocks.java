...
public class ModBlocks {
    ...
    public static final Block INFESTED_MOSSY_COBBLESTONE = register("infested_mossy_cobblestone", p -> new InfestedBlock(Blocks.MOSSY_COBBLESTONE, p), BlockBehaviour.Properties.of().mapColor(MapColor.CLAY), true);
    public static final Block INFESTED_SMOOTH_STONE = register("infested_smooth_stone", p -> new InfestedBlock(Blocks.SMOOTH_STONE, p), BlockBehaviour.Properties.of().mapColor(MapColor.CLAY), true);
    public static final Block INFESTED_COBBLED_DEEPSLATE = register("infested_cobbled_deepslate", p -> new InfestedBlock(Blocks.COBBLED_DEEPSLATE, p), BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).sound(SoundType.DEEPSLATE), true);
    public static final Block INFESTED_CHISELED_DEEPSLATE = register("infested_chiseled_deepslate", p -> new InfestedBlock(Blocks.CHISELED_DEEPSLATE, p), BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).sound(SoundType.DEEPSLATE), true);
    public static final Block INFESTED_POLISHED_DEEPSLATE = register("infested_polished_deepslate", p -> new InfestedBlock(Blocks.POLISHED_DEEPSLATE, p), BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).sound(SoundType.POLISHED_DEEPSLATE), true);
    public static final Block INFESTED_DEEPSLATE_BRICKS = register("infested_deepslate_bricks", p -> new InfestedBlock(Blocks.DEEPSLATE_BRICKS, p), BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).sound(SoundType.DEEPSLATE_BRICKS), true);
    public static final Block INFESTED_CRACKED_DEEPSLATE_BRICKS = register("infested_cracked_deepslate_bricks", p -> new InfestedBlock(Blocks.CRACKED_DEEPSLATE_BRICKS, p), BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).sound(SoundType.DEEPSLATE_BRICKS), true);
    public static final Block INFESTED_DEEPSLATE_TILES = register("infested_deepslate_tiles", p -> new InfestedBlock(Blocks.DEEPSLATE_TILES, p), BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).sound(SoundType.DEEPSLATE_TILES), true);
    public static final Block INFESTED_CRACKED_DEEPSLATE_TILES = register("infested_cracked_deepslate_tiles", p -> new InfestedBlock(Blocks.CRACKED_DEEPSLATE_TILES, p), BlockBehaviour.Properties.of().mapColor(MapColor.DEEPSLATE).sound(SoundType.DEEPSLATE_TILES), true);
    public static final Block INFESTED_BLACKSTONE = register("infested_blackstone", p -> new InfestedBlock(Blocks.BLACKSTONE, p), BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK), true);
    public static final Block INFESTED_POLISHED_BLACKSTONE = register("infested_polished_blackstone", p -> new InfestedBlock(Blocks.POLISHED_BLACKSTONE, p), BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK), true);
    public static final Block INFESTED_POLISHED_BLACKSTONE_BRICKS = register("infested_polished_blackstone_bricks", p -> new InfestedBlock(Blocks.POLISHED_BLACKSTONE_BRICKS, p), BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK), true);
    public static final Block INFESTED_CRACKED_POLISHED_BLACKSTONE_BRICKS = register("infested_cracked_polished_blackstone_bricks", p -> new InfestedBlock(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS, p), BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK), true);
    public static final Block INFESTED_CHISELED_POLISHED_BLACKSTONE = register("infested_chiseled_polished_blackstone", p -> new InfestedBlock(Blocks.CHISELED_POLISHED_BLACKSTONE, p), BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK), true);
    public static final Block WEATHER_DETECTOR = register("weather_detector", WeatherDetectorBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.DAYLIGHT_DETECTOR), true);
    public static final Block MOON_DETECTOR = register("moon_detector", MoonDetectorBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.DAYLIGHT_DETECTOR), true);
    public static final Block BONE_CHIMES = register("bone_chimes", p -> new ChimeBlock(p, SoundEvents.SKELETON_AMBIENT, SoundEvents.BONE_BLOCK_HIT), BlockBehaviour.Properties.ofFullCopy(Blocks.BONE_BLOCK), true);
    public static final Block WHITE_STAINED_TINTED_GLASS = register("white_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block BLACK_STAINED_TINTED_GLASS = register("black_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block BLUE_STAINED_TINTED_GLASS = register("blue_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block BROWN_STAINED_TINTED_GLASS = register("brown_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block PINK_STAINED_TINTED_GLASS = register("pink_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block LIGHT_BLUE_STAINED_TINTED_GLASS = register("light_blue_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block YELLOW_STAINED_TINTED_GLASS = register("yellow_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block PURPLE_STAINED_TINTED_GLASS = register("purple_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block MAGENTA_STAINED_TINTED_GLASS = register("magenta_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block ORANGE_STAINED_TINTED_GLASS = register("orange_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block CYAN_STAINED_TINTED_GLASS = register("cyan_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block GRAY_STAINED_TINTED_GLASS = register("gray_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block GREEN_STAINED_TINTED_GLASS = register("green_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block LIGHT_GRAY_STAINED_TINTED_GLASS = register("light_gray_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block LIME_STAINED_TINTED_GLASS = register("lime_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block RED_STAINED_TINTED_GLASS = register("red_stained_tinted_glass", TintedGlassBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.TINTED_GLASS), true);
    public static final Block WHITE_STAINED_SEA_GLASS = register("white_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block BLACK_STAINED_SEA_GLASS = register("black_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block BLUE_STAINED_SEA_GLASS = register("blue_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block BROWN_STAINED_SEA_GLASS = register("brown_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block PINK_STAINED_SEA_GLASS = register("pink_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block LIGHT_BLUE_STAINED_SEA_GLASS = register("light_blue_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block YELLOW_STAINED_SEA_GLASS = register("yellow_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block PURPLE_STAINED_SEA_GLASS = register("purple_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block MAGENTA_STAINED_SEA_GLASS = register("magenta_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block ORANGE_STAINED_SEA_GLASS = register("orange_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block CYAN_STAINED_SEA_GLASS = register("cyan_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block GRAY_STAINED_SEA_GLASS = register("gray_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block GREEN_STAINED_SEA_GLASS = register("green_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block LIGHT_GRAY_STAINED_SEA_GLASS = register("light_gray_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block LIME_STAINED_SEA_GLASS = register("lime_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
    public static final Block RED_STAINED_SEA_GLASS = register("red_stained_sea_glass", TransparentBlock::new, BlockBehaviour.Properties.ofFullCopy(ModBlocks.SEA_GLASS), true);
